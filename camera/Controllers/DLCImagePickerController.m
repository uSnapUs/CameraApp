...
-(void) loadFilters {
	...
	[self.filterScrollView setContentSize:CGSizeMake(10 + 10*(60+10), 70.0)];
}
...
-(void) showFilters:(id)sender {
    ...
    CGRect filtersRect = [[self filterContainerView]frame];
    toolbarRect.origin.x = 0-toolbarRect.size.width;
    filtersRect.origin.x = 0;
    ...
    [UIView animateWithDuration:0.10
                     ...
                     animations:^{
                         ...
                         [[self filterContainerView] setFrame:filtersRect];
                     } 
...
-(void) hideFilters:(id)sender {
    [self.filtersToggleButton setSelected:NO];
    CGRect toolbarRect = [[self toolbar]frame];
    CGRect filtersRect = [[self filterContainerView]frame];
    toolbarRect.origin.x = 0;
    filtersRect.origin.x = 0+filtersRect.size.width;

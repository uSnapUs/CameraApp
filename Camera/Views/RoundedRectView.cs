...
namespace Camera.Views
{
    public class RoundedRectView : UIView
    {
        ...
        private void UpdateMask()
        {
            ...
            UIBezierPath oMaskPath = UIBezierPath.FromRoundedRect(this.Bounds, this.eRoundedCorners, new SizeF(this.CornerRadius, this.CornerRadius));
